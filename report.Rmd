...
The [Additional Analysis](https://misbath.github.io/bee_project.github.io/add_analysis.html) shows this correlation is quite variable across States, evident by the Pearson correlation coefficient plot. In States like Maryland, where the correlation between pesticide use and bee decline is quite strong, the government is publishing information on bees and conservation efforts, stating that bee decline can be attributed to loss of native plants and pesticides.
