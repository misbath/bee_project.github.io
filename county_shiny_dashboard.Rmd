...
county = pesticides %>% distinct(county) %>% pull()

# selectInput widget
selectInput(
  "county_choice", 
  label = h3("Select County"),
  choices = county, selected = "003")
...
county = merged_county_data %>% distinct(county_fips) %>% pull()
