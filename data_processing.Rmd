...
#%>%
 # mutate(state = if_else(state != "Oth" & state != "Sts 4/ 5/", state, NA) & state != "US 5/" & state != "1/ Honey producing colonies are the maximum number of colonies from which honey was harvested during the year. It is possible to harvest honey from colonies which did not survive the entire year.", state, NA))
