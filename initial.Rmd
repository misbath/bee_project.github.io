...
* Bee population variability from 2002 - 2019  by state and county  
...
*Pesticide Data*
<br>
Pesticide data was obtained from [USGS](https://water.usgs.gov/nawqa/pnsp/usage/maps/county-level/) and was available at the county level. A function was used to read in data from each year, 2002, 2007, 2012, and 2017, located in separate csv files.  Data was filtered for the pesticides of interest so that the merged data file only contained data for those 7 pesticides. The pesticides data was merged to the county and state level bee colony files using the methods described below.
